...
public class EnemyTank : Minion
{
    ...
    public void IdleState(ref Action onEnter, ref Action onExecute, ref Action onExit)
    {
        onEnter = () =>
        {
            timerIdle = UnityEngine.Random.Range(1f,2f);
    ...
    private void OnAttack()
    {
        ...
        BulletE bl = Instantiate(bulletE, pointOfBullet.position, Quaternion.Euler(pointOfBullet.rotation.eulerAngles));
        bl.OnInit();
